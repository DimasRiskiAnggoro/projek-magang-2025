...
export function BlogPost() {
  ...
  const headlineNews = news[0]; // Main headline
  const featuredNews = news.slice(1, 4); // 3 featured articles
  const sidebarNews = news.slice(4, 8); // 4 sidebar articles
  const bottomNews = news.slice(8, 12); // 4 bottom articles
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 md:p-12 w-full relative overflow-hidden">
        ...
        <div className="text-center mb-12 relative z-10 border-b-4 border-gray-900 pb-6">
          <div className="inline-block mb-4">
            <Button 
              color="gray" 
              className="transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl bg-gray-900 text-white font-bold px-6 py-2" 
              size="sm"
            >
              BERITA HARIAN
            </Button>
          ...
          <Typography 
            variant="h2" 
            className="text-center mb-2 font-black text-gray-900 tracking-tight"
          ...
          <Typography
            variant="small"
            className="text-center font-normal text-gray-600 uppercase tracking-widest"
          >
        ...
        <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className={`overflow-hidden transition-all duration-500 ${
                        ...
                        <Image
                          width={800}
                          height={600}
                          src={headlineNews.image_url || 'https://placehold.co/800x600/e2e8f0/64748b?text=No+Image'}
                      ...
                      <div className="flex flex-col justify-between">
                        <div>
                          ...
                          <Typography
                            variant="h2"
                            className={`font-black text-gray-900 mb-4 leading-tight cursor-pointer transition-all duration-300 ${
                              hoveredItem === 'headline' ? 'text-blue-600' : 'hover:text-blue-600'
                            }`}
                            style={{ fontFamily: 'serif' }}
                            onClick={() => window.open(headlineNews.source_url || '#', '_blank')}
                          >
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3">
                            {headlineNews.pdf_url && (
                              <a 
                                href={headlineNews.pdf_url} 
                                target="_blank" 
                            ...
                            {headlineNews.source_url && (
                              <a 
                                href={headlineNews.source_url} 
                                target="_blank" 
                                rel="noopener noreferrer" 
                    ...
                    <CardBody className="p-0">
                      <div className={`w-full mb-3 h-[150px] overflow-hidden ${
                        ...
                        <Image
                          width={400}
                          height={300}
                          src={item.image_url || 'https://placehold.co/400x300/e2e8f0/64748b?text=No+Image'}
                      ...
                      <Typography
                        variant="h6"
                        className={`font-bold text-gray-900 mb-2 leading-tight cursor-pointer transition-all duration-300 ${
                      ...
                      <Typography className="text-sm text-gray-600 mb-3 leading-relaxed">
                        {truncateText(item.excerpt || item.content, 120)}
                      </Typography>
          ...
          <div className="col-span-12 lg:col-span-4 border-l-2 border-gray-900 pl-6">
            <div className="mb-6">
              <Typography variant="h4" className="font-black text-gray-900 mb-4 border-b-2 border-gray-300 pb-2" style={{ fontFamily: 'serif' }}>
                BERITA LAINNYA
              </Typography>
            </div>
                    ...
                    <div className="flex gap-3">
                      <div className={`w-20 h-16 flex-shrink-0 overflow-hidden ${
                        ...
                        <Image
                          width={200}
                          height={150}
                          src={item.image_url || 'https://placehold.co/200x150/e2e8f0/64748b?text=No+Image'}
                      ...
                      <div className="flex-1">
                        <Typography
                          variant="h6"
                          className={`font-bold text-gray-900 mb-1 leading-tight cursor-pointer transition-all duration-300 text-sm ${
        ...
        {/* Bottom Section - Latest News */}
        {bottomNews.length > 0 && (
          <div className="mt-12 pt-8 border-t-2 border-gray-900">
            <Typography variant="h4" className="font-black text-gray-900 mb-6 text-center" style={{ fontFamily: 'serif' }}>
              BERITA TERKINI
            </Typography>
            ...
            <div className="grid md:grid-cols-4 gap-4">
              {bottomNews.map((item, idx) => (
                ...
                >
                  <Card 
                    shadow={false} 
                    className={`p-0 transition-all duration-500 hover:shadow-lg rounded-none ${
                  ...
                  >
                    <CardBody className="p-3">
                      <Typography
                        variant="h6"
                        className={`font-bold text-gray-900 mb-2 leading-tight cursor-pointer transition-all duration-300 text-sm ${
        ...
        {/* "Lihat Selengkapnya" Link - Bottom Right */}
        <div className="flex justify-end mt-8">
          <a 
            href="/berita" 
            className="group flex items-center gap-2 bg-gray-900 text-white px-6 py-3 font-bold uppercase tracking-wider text-sm hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
        ...
        {news.length === 0 && !loading && (
          <div className="text-center py-20">
            ...
            <Typography variant="h5" color="gray" style={{ fontFamily: 'serif' }}>
