...
function Footer() {
  ...
  const topCards = [
    { title: "Seputar", subtitle: "Kota Madiun", icon: "❓", bgColor: "from-teal-400 to-teal-600", links: ["Website Kota Madiun", "SmartCity Kota Madiun", "Data Sektoral Kota Madiun", "SPBE Kota Madiun", "Madiun Today", "E-Book Kota Madiun"] },
    { title: "Seputar", subtitle: "Pelayanan Kota Madiun", icon: "📢", bgColor: "from-teal-500 to-teal-700", links: ["Awak Sigap Kota Madiun", "PPID Kota Madiun", "Kontribusi Berita", "Ayo Ke Madiun"] }
  ];
  const footerSections = [
    { title: "Kominfo Kota Madiun", content: ["Jl. Perintis Kemerdekaan No. 32", "Kel. Kartoharjo, Kecamatan Kartoharjo,", "Kota Madiun, Jawa Timur.", "", "Jam Pelayanan :", "Senin - Kamis (07.00 - 15.30)", "Jumat (06.30 - 14.30)"] },
    { title: "Jelajahi", links: ["Sipdok Kota Madiun", "Beasiswa Kota Madiun", "Awak Sigap Kota Madiun", "Pecat Tumpang Kota Madiun", "Sicaker Kota Madiun", "Madiun Single Submission"] },
    { title: "Agenda Madiun", links: ["Agenda Kota Madiun", "Agenda Walikota Madiun", "Agenda Wakil Walikota Madiun", "Agenda Sekretariat Daerah"] },
    { title: "Berita Madiun", links: ["Madiun Today", "Analisa Berita", "Madiun Kota", "93 FM Suara Madiun", "Seputar Kota Madiun"] }
  ];
  const socialIcons = [
